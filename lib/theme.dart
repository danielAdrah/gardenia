...
class ThemeColor {
  // static Color get primary => Color.fromARGB(253,239,210,255);
  static Color get primary => Color(0xFFF7C1D2);
  static Color get background => Color(0xfffedcd2);
  static var blackColor = Colors.black54;
  static Color get hintFont => Colors.black26;
  // static Color get primary => const Color(0xfffff5d5 );
